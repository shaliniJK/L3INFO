...
public class MultiAnswerNumerical extends MultiAnswer<Integer> {
	
	public MultiAnswerNumerical(String listAnswer) {
		super(listAnswer);
	}
    ...
    public AnswerPanel<?> createView(AnswerPanelFactory answerPanelFactory) {
        return answerPanelFactory.createMultiAnswerNumericalPanel(this);
    }
}
